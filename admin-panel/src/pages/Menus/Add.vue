              ...
              <div class="col-md-12">
                ...
                >
                  ...
                  <div v-if="!menuItem.imagePreview" class="upload-placeholder">
                    ...
                    <small class="text-muted">Supported formats: JPG, PNG, GIF (Large images will be automatically compressed)</small>
                  </div>
  ...
  methods: {
    ...
    async processImageFile(file) {
      ...
      try {
        ...
        this.menuItem.image = processedFile;
    ...
    async submitMenuItem() {
      ...
      try {
        ...
        // Add image if provided with validation
        if (this.menuItem.image) {
          // Final validation before upload
          if (this.menuItem.image.size > 2 * 1024 * 1024) { // 2MB final check
          ...
          throw new Error('Image is required for menu item creation');
        }
